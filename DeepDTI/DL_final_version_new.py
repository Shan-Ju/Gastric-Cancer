...
def Data_prerpocessing_label1():
    # load data
    file_drug = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM1_ESM.csv', header=None) #drug data
    file_drug = file_drug.rename({0:'drug'}, axis=1)
    file_target = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM2_ESM.csv', header=None) #target data
    file_target = file_target.rename({0:'target'}, axis=1)
    file_drug_mat = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM6_ESM.csv', header=None) #drug vector
    file_target_mat = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM7_ESM.csv', header=None) #target vector
    file_interact_mat = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM3_ESM.csv', header=None) #interact vector
    ...
    file = open('/Users/shanjuyeh/Desktop/Project/DL藥物project/new/output/data_label_1.pickle', 'wb')
    pickle.dump(df, file)
    file.close()
...
def Data_prerpocessing_label0(num):
    ...
    #load data
    DRUG_FEATURE=pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM6_ESM.csv', header=None).values.reshape(5877,193)
    TARGET_FEATURE=pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM7_ESM.csv', header=None).values.reshape(3348,1290)
    Target_name = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM2_ESM.csv', header=None)
    Target_name = Target_name.rename({0:'target'}, axis=1)
    Drug_name = pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM1_ESM.csv', header=None)
    Drug_name = Drug_name.rename({0:'drug'}, axis=1)
    interaction_matrix=pd.read_csv('/Users/shanjuyeh/Desktop/Project/DL藥物project/12859_2016_1377_MOESM3_ESM.csv', header=None).values
    ...
    with open('/Users/shanjuyeh/Desktop/Project/DL藥物project/new/output/'+ filename, 'wb') as f_out:
...
def Oversampling(filename, num):
    file = open('/Users/shanjuyeh/Desktop/Project/DL藥物project/new/output/' + filename, 'rb')
    DB = pickle.load(file)
    ...
    #store data
    file = open('/Users/shanjuyeh/Desktop/Project/DL藥物project/new/output/LABEL_ONE_OVERSAMPLE_cluster100.pickle', 'wb')
    pickle.dump(DB, file)
    file.close()
...
def pca(dataMat,n):
    ...
    if os.path.isfile('C:\\Users\\kimomo\\Desktop\\DL藥物project\\PCA_matrix.pickle'):
